...
/**
 * نگاشت شهر → IDهای TeamMember که در آن دفتر خدمت می‌دهند.
 *
 * فعلاً هاردکد است چون یک وکیل ممکن است چند شهر را پوشش دهد و مدل
 * `TeamMember` هنوز فیلد رابطه‌ی چند-به-چند ندارد. وقتی داشبورد امکان
 * مدیریت این نگاشت را داشت، این constant به یک relation در Prisma منتقل
 * می‌شود و همه مصرف‌کنندگان بدون تغییر منطق سوئیچ می‌کنند.
 */
export const officeToLawyerIds: Record<OfficeId, number[]> = {
  tehran: [4],
  ahvaz: [4, 2, 3, 5],
  andimeshk: [3, 5],
};
...
/**
 * برای هر وکیل، شهرهای تحت پوشش (برای نمایش روی کارت وکیل در صفحه شهر).
 * ترتیب مهم است: اولین مورد شهر اصلی است.
 */
export const lawyerCoverage: Record<number, string[]> = {
  4: ["تهران", "کرج", "شهرهای استان تهران", "اهواز"],
  2: ["اهواز", "شوشتر", "دزفول", "شوش", "سوسنگرد", "حمیدیه", "کارون", "رامهرمز", "بندر امام خمینی", "ماهشهر"],
  3: ["اندیمشک", "دزفول", "شوش", "اهواز", "شوشتر"],
  5: ["اندیمشک", "دزفول", "شوش", "اهواز", "شوشتر"],
};
