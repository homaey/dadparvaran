...
export interface ServiceDetail {
  ...
  parentSlug?: string;
  icon: typeof Scale;
  /** مقالهٔ پشتیبان مرتبط (لینک داخلی از صفحهٔ خدمت به مقالهٔ مقایسه‌ای/آموزشی). */
...
export const servicesData: ServiceDetail[] = [
  ...
  },
  {
    ...
    metaTitleFA: "وکیل خانواده و طلاق | مهریه، نفقه و حضانت | دادپروران",
    metaTitleEN: "Family & Divorce Lawyer | Mahr, Alimony & Custody | Dadparvaraan",
    metaDescFA: "خدمات وکالت دعاوی خانواده شامل طلاق توافقی و یک‌طرفه، مطالبه مهریه و نفقه، حضانت و ملاقات فرزند، جهیزیه و اجرای احکام خانواده.",
    metaDescEN: "Family law services: consensual and unilateral divorce, dowry and alimony claims, child custody and visitation, trousseau recovery and family judgment enforcement.",
    heroDescFA: "بررسی و پیگیری دعاوی خانواده، از مشاوره پیش از اقدام و تنظیم توافق‌نامه تا طرح دعوا، دفاع، کارشناسی و اجرای رأی.",
    heroDescEN: "Family dispute resolution: from pre-action consultation and agreement drafting to litigation, defense, expert assessment and judgment enforcement.",
    contentFA: [
      "اختلافات خانوادگی فقط یک پرونده قضایی نیستند. تصمیمی که درباره طلاق، مهریه، نفقه یا حضانت گرفته می‌شود، می‌تواند بر وضعیت مالی، محل زندگی و آرامش فرزندان اثر طولانی‌مدت داشته باشد.",
      "در بعضی پرونده‌ها، مسئله اصلی تنظیم یک توافق روشن و قابل اجراست. در برخی دیگر، باید حق مالی، عسر و حرج، ترک انفاق، سوءرفتار یا مصلحت کودک اثبات شود. گاهی نیز چند دعوا به‌طور هم‌زمان جریان دارد و اقدام ناهماهنگ در یک پرونده می‌تواند بر پرونده دیگر اثر بگذارد.",
      "دادپروران در زمینه بررسی و پیگیری دعاوی خانواده، از مشاوره پیش از اقدام و تنظیم توافق‌نامه تا طرح دعوا، دفاع، کارشناسی و اجرای رأی، خدمات حقوقی ارائه می‌کند.",
    ],
    contentEN: [
      "Family disputes are not just a court case. Decisions about divorce, dowry, alimony, or custody can have lasting effects on finances, living arrangements, and children's well-being.",
      "In some cases, the main issue is drafting a clear, enforceable agreement. In others, financial rights, hardship, failure to maintain, or child welfare must be proven. Sometimes multiple cases run simultaneously and uncoordinated action in one can affect another.",
      "Dadparvaraan provides legal services from pre-action consultation and agreement drafting to litigation, defense, expert assessment and judgment enforcement.",
    ],
    pointsFA: [
      "طلاق توافقی و تنظیم توافق‌نامه",
      "طلاق از طرف زن (شروط عقد، عسر و حرج)",
      "طلاق از طرف مرد با تعیین حقوق مالی",
      "مطالبه و اجرای مهریه",
      "نفقه زوجه و نفقه فرزند",
      "حضانت و ملاقات فرزند",
      "استرداد جهیزیه، اجرت‌المثل و شرط تنصیف",
      "اجرای احکام خانواده و اقدامات فوری",
    ],
    pointsEN: [
      "Consensual divorce and agreement drafting",
      "Wife-initiated divorce (contract conditions, hardship)",
      "Husband-initiated divorce with financial rights",
      "Dowry claim and enforcement",
      "Spousal and child support",
      "Child custody and visitation",
      "Trousseau recovery, service compensation & asset division",
      "Family judgment enforcement and urgent measures",
    ],
    faqsFA: [
      { q: "آیا زن بدون رضایت شوهر می‌تواند طلاق بگیرد؟", a: "در صورت وجود یکی از مبانی قانونی مانند شروط ضمن عقد، عدم پرداخت نفقه با شرایط مقرر یا اثبات عسر و حرج، امکان درخواست طلاق وجود دارد. صرف تمایل به جدایی بدون مبنای قابل اثبات کافی نیست." },
      { q: "آیا مطالبه مهریه نیازمند طلاق است؟", a: "خیر. زن از زمان عقد مالک مهریه است و مطالبه آن به طرح طلاق وابسته نیست." },
      { q: "حضانت فرزند بعد از هفت‌سالگی با چه کسی است؟", a: "در صورت اختلاف، دادگاه با رعایت مصلحت کودک تصمیم می‌گیرد. وضعیت پس از هفت‌سالگی نباید بدون توجه به مصلحت کودک به‌صورت مطلق بیان شود." },
      { q: "آیا توافق والدین درباره حضانت قطعی و غیرقابل تغییر است؟", a: "اگر توافق برخلاف مصلحت کودک باشد یا شرایط تغییر کند، دادگاه می‌تواند تصمیم دیگری بگیرد." },
      { q: "آیا عدم پرداخت نفقه فقط دعوای حقوقی است؟", a: "خیر. علاوه بر مطالبه حقوقی، در صورت وجود استطاعت و سایر شرایط قانونی، ترک انفاق می‌تواند موضوع شکایت کیفری باشد." },
    ],
    faqsEN: [
      { q: "Can a wife divorce without husband's consent?", a: "If legal grounds exist (contract conditions, non-payment of maintenance, or proven hardship), divorce can be requested. Mere desire to separate without provable basis is insufficient." },
      { q: "Is divorce required to claim dowry?", a: "No. The wife owns the dowry from the time of marriage; claiming it is independent of divorce proceedings." },
      { q: "Who gets custody after age 7?", a: "In case of disagreement, the court decides based on the child's best interest. The outcome after age 7 should not be stated absolutely without considering the child's welfare." },
    ],
    keywordsFA: ["وکیل خانواده و طلاق", "وکیل مهریه", "وکیل نفقه", "وکیل حضانت فرزند", "وکیل طلاق توافقی", "وکیل طلاق از طرف زن"],
    keywordsEN: ["family lawyer", "divorce lawyer Tehran", "child custody attorney", "alimony lawyer", "dowry lawyer Iran"],
  },
  {
    slug: "commercial",
    icon: Building2,
  ...
  },
  {
    ...
    parentSlug: "check",
    icon: Banknote,
    titleFA: "وصول مطالبات و اجرای چک‌های صیادی",
    titleEN: "Check Collection & Enforcement",
    metaTitleFA: "وکیل وصول چک صیادی | اجرای چک برگشتی و توقیف اموال | دادپروران",
    metaTitleEN: "Check Collection & Enforcement | Bounced Check Recovery | Dadparvaraan",
    metaDescFA: "خدمات حقوقی وصول چک صیادی و چک برگشتی؛ بررسی امکان اجرائیه مستقیم، اجرای ثبت، دادخواست مطالبه وجه، تأمین خواسته و پیگیری اجرای حکم.",
    metaDescEN: "Legal services for Sayad check collection and bounced check recovery: direct enforcement, registration execution, court claims, and asset seizure.",
    heroDescFA: "بررسی چک، انتخاب مسیر وصول، درخواست تأمین و توقیف اموال، طرح دعوا و پیگیری عملیات اجرایی.",
    heroDescEN: "Check assessment, recovery path selection, asset seizure, litigation, and enforcement operations.",
    contentFA: [
      "برگشت خوردن چک به معنای انتخاب خودکار یک مسیر واحد نیست. دارنده چک ممکن است، با توجه به متن و وضعیت چک، امکان استفاده از اجرائیه مستقیم قضایی موضوع ماده ۲۳ قانون صدور چک، اجرای ثبت، دادخواست مطالبه وجه یا در صورت وجود شرایط قانونی، شکایت کیفری صدور چک بلامحل را داشته باشد.",
      "هر مسیر، اشخاص مسئول و آثار متفاوتی دارد. اجرائیه مستقیم ماده ۲۳ همه خواسته‌ها یا مسئولان چک را پوشش نمی‌دهد و در چک‌های جدید نیز ثبت و انتقال در سامانه صیاد باید بررسی شود.",
      "دادپروران در زمینه بررسی چک، انتخاب مسیر وصول، درخواست تأمین و توقیف اموال، طرح دعوا، دفاع در برابر ادعاهای مربوط به چک و پیگیری عملیات اجرایی خدمات حقوقی ارائه می‌کند.",
    ],
    contentEN: [
      "A bounced check doesn't automatically determine a single path. Depending on the check text and status, the holder may pursue direct judicial enforcement (Article 23), registration execution, a court claim, or criminal complaint.",
      "Each path involves different responsible parties and legal effects. Dadparvaraan provides legal services for check assessment, recovery path selection, asset seizure, litigation, and enforcement operations.",
    ],
    pointsFA: ["بررسی اعتبار و ثبت صیاد", "اجرائیه مستقیم ماده ۲۳", "اجرای ثبت اسناد لازم‌الاجرا", "دادخواست مطالبه وجه و خسارت", "تأمین خواسته و توقیف اموال", "شکایت کیفری صدور چک بلامحل", "دفاع از صادرکننده و ضامن", "پیگیری عملیات اجرایی تا تسویه"],
    pointsEN: ["Sayad registration verification", "Direct enforcement (Article 23)", "Registration execution", "Court claim with delay damages", "Injunction & asset seizure", "Criminal complaint", "Defense of issuer/guarantor", "Enforcement until settlement"],
    faqsFA: [
      { q: "آیا برای چک برگشتی می‌توان مستقیماً اجرائیه گرفت؟", a: "در صورت وجود شرایط ماده ۲۳ قانون صدور چک، دارنده می‌تواند از دادگاه صالح صدور اجرائیه بخواهد. متن چک، علت گواهی عدم پرداخت و اشخاص مسئول باید پیش از درخواست بررسی شوند." },
      { q: "آیا اجرائیه مستقیم شامل خسارت تأخیر تأدیه نیز می‌شود؟", a: "ماده ۲۳ به کسری مبلغ چک و حق‌الوکاله قانونی اشاره کرده است. برای خسارت تأخیر تأدیه ممکن است طرح خواسته جداگانه لازم باشد." },
      { q: "اگر چک صیادی در سامانه ثبت نشده باشد چه می‌شود؟", a: "بر اساس مقررات جاری بانکی، احکام قانون صدور چک نسبت به چک ثبت‌نشده جدید صیادی به شکل معمول اعمال نمی‌شود. رابطه پایه و امکان مطالبه طلب باید جداگانه بررسی شود." },
      { q: "آیا می‌توان از ضامن یا ظهرنویس نیز مطالبه کرد؟", a: "حسب نوع چک، نحوه انتقال، متن ضمانت و رعایت مهلت‌های قانونی، مسئولیت ضامن یا ظهرنویس قابل بررسی است. اجرائیه مستقیم ماده ۲۳ لزوماً جایگزین دعوای مطالبه علیه این اشخاص نیست." },
      { q: "آیا می‌توان اموال صادرکننده را فوراً توقیف کرد؟", a: "در بعضی مسیرها امکان درخواست تأمین یا توقیف وجود دارد، اما صدور و اجرای آن به مدارک، شرایط قانونی، مالکیت مال و مستثنیات دین بستگی دارد." },
    ],
    faqsEN: [
      { q: "Can I get direct enforcement for a bounced check?", a: "If Article 23 conditions are met, the holder can request enforcement from the competent court. Check text, reason for non-payment, and responsible parties must be verified first." },
      { q: "Does direct enforcement include delay damages?", a: "Article 23 refers to the deficit amount and statutory attorney fees. Delay damages may require a separate claim." },
    ],
    keywordsFA: ["وکیل وصول چک صیادی", "اجرای چک صیادی", "وکیل چک برگشتی", "وصول چک برگشتی", "اجرائیه مستقیم چک", "توقیف اموال صادرکننده چک"],
    keywordsEN: ["check collection lawyer", "Sayad check enforcement", "bounced check recovery", "direct check enforcement"],
  },
  // ═══════════════════════════════════════════════════════════════════════
  // زیرتخصص‌های کیفری
  // ═══════════════════════════════════════════════════════════════════════
  ...
  {
    slug: "possession-disputes",
    parentSlug: "property",
    icon: Gavel,
    relatedArticleSlug: "تفاوت-خلع-ید-تصرف-عدوانی-تخلیه",
    relatedArticleTitle: "تفاوت خلع ید، رفع تصرف عدوانی و تخلیه چیست؟",
    titleFA: "وکیل خلع ید و رفع تصرف عدوانی",
    titleEN: "Property Possession & Trespass Dispute Lawyer",
    metaTitleFA: "وکیل خلع ید و رفع تصرف عدوانی | خدمات دعاوی ملکی",
    metaTitleEN: "Property Possession & Trespass Dispute Lawyer | Dadparvaraan Mehr Iran",
    metaDescFA:
      "خدمات وکالت خلع ید، رفع تصرف عدوانی، مزاحمت و ممانعت از حق؛ بررسی اسناد، انتخاب دعوای صحیح، تنظیم دادخواست و پیگیری اجرای رأی.",
    metaDescEN:
      "Legal representation for eviction, removal of adverse possession, interference and obstruction claims: document review, choosing the correct action, drafting the petition, and enforcing the judgment.",
    heroDescFA:
      "برای تشخیص مسیر مناسب، تصویر سند یا مدرک مالکیت و شرح مختصر نحوه تصرف یا مزاحمت را ارسال کنید.",
    heroDescEN:
    ...
    contentFA: [
      "تصرف بدون اجازه یک ملک، بستن مسیر عبور، جلوگیری از استفاده مالک یا شریک، تجاوز به حدود زمین و ایجاد مانع در استفاده از پارکینگ، انباری یا مشاعات، همگی اختلافات ملکی‌اند؛ اما لزوماً با یک نوع دعوا پیگیری نمی‌شوند.",
      "در بعضی پرونده‌ها باید دعوای خلع ید مطرح شود؛ در برخی موارد اقدام صحیح رفع تصرف عدوانی است و گاهی باید برای رفع مزاحمت یا رفع ممانعت از حق اقدام کرد. انتخاب اشتباه عنوان دعوا می‌تواند موجب رد یا عدم استماع دعوا، اتلاف زمان و تحمیل هزینه‌های اضافی شود.",
      "به همین دلیل پیش از تنظیم دادخواست باید مالکیت، سابقه تصرف، نحوه ورود طرف مقابل، وضعیت ثبتی ملک و نتیجه مورد انتظار بررسی شود. صرف شباهت ظاهری پرونده به یک نمونه، برای تعیین نوع دعوا کافی نیست.",
      "مؤسسه حقوقی دادپروران در بررسی، طرح، دفاع و پیگیری دعاوی خلع ید، تصرف عدوانی، مزاحمت و ممانعت از حق — از ارزیابی اولیه مدارک تا اجرای رأی — خدمات حقوقی ارائه می‌کند. هیچ نتیجه‌ای در پرونده‌های قضایی قابل تضمین نیست و ارزیابی هر پرونده بر اساس مدارک، قوانین معتبر و شرایط اختصاصی آن انجام می‌شود.",
    ],
    contentEN: [
    ...
    pointsFA: [
      ...
      "تخلیه ملک و الزام به تحویل ملک",
      "ابطال سند یا اثبات مالکیت",
      "قلع‌وقمع بنا و رفع آثار تجاوز",
      "مطالبه اجرت‌المثل ایام تصرف",
      "درخواست تأمین دلیل و دستور موقت",
      "دفاع از خوانده در دعاوی تصرف",
      "شکایت کیفری در صورت وجود شرایط قانونی",
    ],
    pointsEN: [
      "Eviction (khal'-e yad)",
    ...
    faqsFA: [
      {
        q: "آیا برای خلع ید باید سند رسمی داشته باشیم؟",
        a: "خلع ید دعوایی مبتنی بر مالکیت است و اثبات مالکیت در آن اهمیت اساسی دارد. نوع سند و وضعیت ثبتی ملک باید پیش از طرح دعوا بررسی شود.",
      },
      {
        q: "آیا علیه شریک ملک مشاع می‌توان اقدام کرد؟",
        a: "بله، در صورت محروم کردن سایر شرکا از تصرف یا استفاده، امکان طرح دعوای مناسب وجود دارد و قانون مزاحمت یا ممانعت برخی از شرکا نسبت به دیگران را حسب مورد مشمول مقررات دعاوی تصرف دانسته است.",
      },
      {
        q: "آیا مستأجر می‌تواند دعوای تصرف عدوانی مطرح کند؟",
        a: "در شرایط قانونی، مستأجر یا شخصی که ملک را از طرف دیگری در اختیار دارد نیز می‌تواند برای حمایت از تصرف خود اقدام کند.",
      },
      {
        q: "آیا اجرت‌المثل ایام تصرف قابل مطالبه است؟",
        a: "در بسیاری از پرونده‌ها امکان بررسی و مطالبه اجرت‌المثل وجود دارد؛ اما شیوه طرح آن به نوع دعوا، مدت تصرف و دلایل موجود بستگی دارد.",
      },
      {
        q: "رسیدگی به پرونده چه مدت طول می‌کشد؟",
        a: "زمان رسیدگی ثابت نیست و به مرجع صالح، کارشناسی، تعداد طرف‌ها، وضعیت ثبتی ملک، اعتراض‌ها و اجرای رأی بستگی دارد. ارائه زمان قطعی پیش از بررسی پرونده صحیح نیست.",
      },
    ],
    faqsEN: [
      {
        q: "Do we need an official deed to file for eviction?",
        a: "Eviction is an ownership-based action, so proving ownership is essential. The type of deed and the property's registration status should be reviewed before filing.",
      },
      {
        q: "Can action be taken against a co-owner of a shared property?",
        a: "Yes. If other co-owners are being deprived of possession or use, an appropriate claim can be filed; the law treats interference or obstruction by some co-owners against others as a possession dispute where applicable.",
      },
      {
        q: "Can a tenant file an adverse-possession claim?",
        a: "Under the right legal conditions, a tenant or anyone holding the property on another's behalf can also act to protect their possession.",
      },
      {
        q: "Can rent-equivalent for the possession period be claimed?",
        a: "In many cases rent-equivalent can be assessed and claimed, but how it is pursued depends on the type of action, the length of possession and the available evidence.",
      },
      {
        q: "How long does the case take?",
        a: "There is no fixed timeline; it depends on the competent authority, expert examination, the number of parties, the property's registration status, appeals and enforcement. A definite time cannot be given before reviewing the case.",
      },
    ],
    keywordsFA: [
      "وکیل خلع ید و رفع تصرف عدوانی",
      "وکیل خلع ید",
      "رفع تصرف عدوانی",
      "رفع مزاحمت",
      "ممانعت از حق",
    ...
    keywordsEN: [
      "property possession lawyer",
      "adverse possession removal",
      "eviction lawyer iran",
      "khal e yad",
      "property trespass claim",
    ],
  },
];
